! function(t) {
            ...
            var r = "undefined" != typeof window ? window : t.exports && void 0 !== i ? i : {},
                o = function(t) {
                    ...
                    var r, o, s, a, l, u, c, f = function(t) {
                        ...
                        v = function(t, n, r, o) {
                            ...
                            this.check = function(a) {
                                ...
                                if (0 === d && r)
                                    for (c = (u = ("com.greensock." + t).split(".")).pop(), h = f(u.join("."))[c] = this.gsClass = r.apply(r, s), o && (i[c] = e[c] = h), p = 0; p < this.sc.length; p++) this.sc[p].check()
                            }, this.check(!0)
                        },
                    ...
                    var w = [0, 0, 1, 1],
                        ...
                        T = b.register = function(t, e, n, i) {
                            for (var r, o, s, a, l = e.split(","), u = l.length, c = (n || "easeIn,easeOut,easeInOut").split(","); --u > -1;)
                                for (o = l[u], r = i ? _("easing." + o, null, !0) : h.easing[o] || {}, s = c.length; --s > -1;) a = c[s], x[o + "." + a] = x[a + o] = r[a] = t.getRatio ? t : t[a] || new t
                        };
                    ...
                    var R = _("TweenLite", function(e, n, i) {
                            ...
                            if (this._overwrite = l = null == l ? $[R.defaultOverwrite] : "number" == typeof l ? l >> 0 : $[l], (a || e instanceof Array || e.push && m(e)) && "number" != typeof e[0])
                    ...
                    s._init = function() {
                        ...
                        if (this._ease = c = c ? c instanceof b ? c : "function" == typeof c ? new b(c, s.easeParams) : x[c] || R.defaultEase : R.defaultEase, s.easeParams instanceof Array && c.config && (this._ease = c.config.apply(c, s.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
                        ...
                        for (s in j[e._gsTweenID] && Q(), this.vars.css || e.style && e !== t && e.nodeType && W.css && !1 !== this.vars.autoCSS && function(t, e) {
                            ...
                            if (f = this.vars[s], U[s]) f && (f instanceof Array || f.push && m(f)) && -1 !== f.join("").indexOf("{self}") && (this.vars[s] = f = this._swapSelfInParams(f, this));
    ...
    i._gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function() {
        var t = function(t) {
            ...
            p = function(t) {
                ...
                return function(t, u, c) {
                    var f, h, p, d, m, g, v, y, _, w = (c || e).length,
                        b = o[w];
                    if (!b) {
        ...
        return t.version = "2.1.3", t.distribute = p, d.constructor = t, d.kill()._gc = d._forcingPlayhead = d._hasPause = !1, d.to = function(t, e, n, r) {
            ...
            var i, r, o, l, u, c, f, h, p = this._time,
    ...
    ! function(e, n) {
        ...
        var T =
             ...
             */
            function(t) {
                var e, n, i, r, o, s, a, l, u, c, f, h, p, d, m, g, v, y, _, w = "sizzle" + 1 * new Date,
                    b = t.document,
                    x = 0,
                    T = 0,
                    S = lt(),
                                ...
                                return 1 === i && 0 === r ? function(t) {
                                    ...
                                    if (g) {
                                        ...
                                        if (d = [s ? g.firstChild : g.lastChild], s && y) {
                                            for (_ = (p = (u = (c = (f = (h = g)[w] || (h[w] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] || [])[0] === x && u[1]) && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (_ = p = 0) || d.pop();)
                                                if (1 === h.nodeType && ++_ && h === e) {
                                                    c[t] = [x, p, _];
                                                    break
                                                }
                                        } else if (y && (_ = p = (u = (c = (f = (h = e)[w] || (h[w] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] || [])[0] === x && u[1]), !1 === _)
                                            for (;
                                                (h = ++p && h && h[m] || (_ = p = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++_ || (y && ((c = (f = h[w] || (h[w] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] = [x, _]), h !== e)););
        ...
        (w.fn.init = function(t, e, n) {
            ...
            if (n = n || A, "string" == typeof t) {
                ...
                if (r[1]) {
                    if (e = e instanceof w ? e[0] : e, w.merge(this, w.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : i, !0)), C.test(r[1]) && w.isPlainObject(e))
        ...
        w.event = {
            ...
            add: function(t, e, n, i, r) {
                ...
                if (g)
                    for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(it, r), n.guid || (n.guid = w.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                ...
                if (g && (l = g.events)) {
                    for (u = (e = (e || "").match(j) || [""]).length; u--;)
                        if (p = m = (a = St.exec(e[u]) || [])[1], d = (a[2] || "").split(".").sort(), p) {
                            ...
                            for (p in l) w.event.remove(t, p + e[u], n, i, !0);
        ...
        function zt(t, e, n, i) {
            ...
            if (h && (o = (r = bt(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
                ...
                if (l)
                    for (c = a[a.length - 1].ownerDocument, w.map(a, Lt), f = 0; f < l; f++) u = a[f], dt.test(u.type || "") && !G.access(u, "globalEval") && w.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? w._evalUrl && !u.noModule && w._evalUrl(u.src, {
        ...
        w.extend({
            ...
            clone: function(t, e, n) {
                ...
                if (!(d.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || w.isXMLDoc(t)))
                    for (s = gt(a), i = 0, r = (o = gt(t)).length; i < r; i++) Ft(o[i], s[i]);
                if (e)
                    if (n)
                        for (o = o || gt(t), s = s || gt(a), i = 0, r = o.length; i < r; i++) It(o[i], s[i]);
                    else It(t, a);
        ...
        function he(t, e, n) {
            ...
            for (! function(t, e) {
                ...
                if (i = he.prefilters[o].call(u, t, c, u.opts)) return m(i.stop) && (w._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
        ...
        w.Animation = w.extend(he, {
                ...
                prefilters: [function(t, e, n) {
                    ...
                    if ((l = !w.isEmptyObject(e)) || !w.isEmptyObject(p))
                        for (i in f && 1 === t.nodeType && (n.overflow = [d.overflow, d.overflowX, d.overflowY], null == (u = g && g.display) && (u = G.get(t, "display")), "none" === (c = w.css(t, "display")) && (u ? c = u : (ft([t], !0), u = t.style.display || u, c = w.css(t, "display"), ft([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === w.css(t, "float") && (l || (h.done(function() {
                                d.display = u
        ...
        w.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && i ? e ? this.addClass(t) : this.removeClass(t) : m(t) ? this.each(function(n) {
                    ...
                    var e, r, o, s;
                    if (i)
                        for (r = 0, o = w(this), s = _e(t); e = s[r++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                    else void 0 !== t && "boolean" !== n || ((e = ye(this)) && G.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : G.get(this, "__className__") || ""))
                })
            },
            hasClass: function(t) {
                var e, n, i = 0;
        ...
        w.extend(w.event, {
            trigger: function(e, n, r, o) {
                ...
                if (a = d = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !be.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (_ = y.split("."), y = _.shift(), _.sort()), c = y.indexOf(":") < 0 && "on" + y, (e = e[w.expando] ? e : new w.Event(y, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = _.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + _.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : w.makeArray(n, [e]), p = w.event.special[y] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                    ...
                    for (s = 0;
                        (a = v[s++]) && !e.isPropagationStopped();) d = a, e.type = s > 1 ? u : p.bindType || y, (h = (G.get(a, "events") || {})[e.type] && G.get(a, "handle")) && h.apply(a, n), (h = c && a[c]) && h.apply && $(a) && (e.result = h.apply(a, n), !1 === e.result && e.preventDefault());
        ...
        qe.href = Te.href, w.extend({
            ...
            ajax: function(e, n) {
                ...
                var r, o, s, a, l, u, c, f, h, p, d = w.ajaxSetup({}, n),
                    m = d.context || d,
        ...
        d.cors = !!Ye && "withCredentials" in Ye, d.ajax = Ye = !!Ye, w.ajaxTransport(function(e) {
            ...
            if (d.cors || Ye && !e.crossDomain) return {
                send: function(r, o) {
                    ...
                    n = function(t) {
                        return function() {
                            n && (n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Xe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
    ...
    (e = t.exports = function(t, e, n, f, h) {
        ...
        if (o(v)) {
            for (p = a(t.length); p > _; _++)
                if ((g = e ? y(s(d = t[_])[0], d[1]) : y(t[_])) === u || g === c) return g
        } else
            for (m = v.call(t); !(d = m.next()).done;)
                if ((g = r(m, y, d.value, e)) === u || g === c) return g
    }).BREAK = u, e.RETURN = c
}, function(t, e) {
    var n = 0,
        i = Math.random();
    ...
    var p = function() {
        ...
        d = {
            home: {
                enter: function(t, e) {
                    ...
                    return (0, i.default)(a.words).css({
                        ...
                        ease: u.Expo.easeOut,
                        force3D: !0
                    }, .05, 1.4), p() || n.fromTo(h, 2.5, {
                        y: 450
                    }, {
                        y: 0,
                        force3D: !0,
                        ease: u.Expo.easeOut
                    }, .9), d.length && n.fromTo(d, 2, {
                        y: 250,
                        opacity: 0
                    }, {
                        y: 0,
                ...
                magic: function(t, e) {
                    ...
                    o.mobile || (t.find(".wt-hero-header,.wt-envelope,.wt-showreel,.wt-feature,.wt-advantage-header,.wt-advantage-details,.wt-description,.wt-getapp-fill,.wt-getapp-container").each(function() {
                        ...
                        new IntersectionObserver(function(e) {
                            e.forEach(function(e) {
                                e.isIntersecting ? s() : (cancelAnimationFrame(n), m || r.default.set(t, {
                                    skewY: 0
                                }))
                            })
                        }).observe(this)
                        ...
                        var t = (0, i.default)(this),
                            e = (t.find(".wt-showreel-roll-item"), new f.default.Scene({
                                duration: function() {
                                    return "200%"
                                },
                                triggerHook: 0,
                    ...
                    return s.each(function() {
                        ...
                        var t, e = (0, i.default)(this).find(".wt-showreel-roll-item"),
                            r = new f.default.Scene({
                                duration: function() {
                                    return l.height()
                                },
                                triggerHook: .7,
            ...
            about: {
                ...
                magic: function(t, e) {
                    var n = new f.default.Controller(e.controller),
                        r = (e.app, t.find(".wt-envelope")),
                        o = t.find(".wt-description"),
                        s = (t.find(".wt-getapp"), t.find(".wt-outro"));
            ...
            faq: {
                enter: function(t) {
                    var e, n, r, s = new o.default({
                        ...
                        a = t.find(".wt-faq-header-title h1"),
                        l = new c.default(a, {
                            type: "words"
                        }),
                        ...
                        h = t.find(".wt-faq-footer"),
                        p = t.find(".wt-faq-header-action-item");
                ...
                magic: function(t, e) {
                    var n = new f.default.Controller(e.controller);
                    e.app, t.find(".wt-faq").find(".wt-faq-footer"), t.find(".wt-getapp");
            ...
            feature: {
                ...
                shift: function(t, e) {
                    var n = new o.default,
                        ...
                        s = i.eq(e);
                    return r.default.killTweensOf(i), n.to(i, .6, {
                        attr: {
                            scale: 80
                        }
                    }, 0), n.to(s, .6, {
    ...
    t.exports = function(t, e, n, d, m, g, v) {
        ...
        if (P && (w = c(P.call(new t))) !== Object.prototype && w.next && (u(w, x, !0), i || "function" == typeof w[f] || s(w, f, p)), T && O && "values" !== O.name && (S = !0, k = function() {
                return O.call(this)
            }), i && !v || !h && !S && E[f] || s(E, f, k), a[e] = k, a[x] = p, m)
            if (y = {
                    values: T ? k : b("values"),
                    keys: g ? k : b("keys"),
                    entries: C
    ...
    for (var i = n(81), r = n(34), o = n(8), s = n(3), a = n(14), l = n(17), u = n(1), c = u("iterator"), f = u("toStringTag"), h = l.Array, p = {
        ...
        var g, v = d[m],
            ...
            _ = s[v],
            w = _ && _.prototype;
        if (w && (w[c] || a(w, c, h), w[f] || a(w, f, v), l[v] = h, y))
    ...
    t.exports = !u || n(16)(function() {
        ...
        for (var n = a(t), u = arguments.length, c = 1, f = o.f, h = s.f; u > c;)
            for (var p, d = l(arguments[c++]), m = f ? r(d).concat(f(d)) : r(d), g = m.length, v = 0; g > v;) p = m[v++], i && !h.call(d, p) || (n[p] = d[p]);
        return n
    } : u
}, function(t, e, n) {
    "use strict";
    ...
    i = void 0, r = function() {
        ...
        t.version = "2.0.6", window.addEventListener("mousewheel", function() {}), t.Controller = function(n) {
            ...
            return this.addScene = function(e) {
                    ...
                    else if (e instanceof t.Scene) e.controller() === l ? l.scrollTo(e.scrollOffset(), n) : E(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", e);
        ...
        t.Controller.addOption = function(t, n) {
            ...
            this.addTo = function(e) {
                return e instanceof t.Controller ? o != e && (o && o.removeScene(l), o = e, S(), w(!0), b(!0), _(), o.info("container").addEventListener("resize", x), e.addScene(l), l.trigger("add", {
                    controller: o
    ...
    ***************************************************************************** */
                    ...
                    function(t, e, n, i, r) {
                        ...
                        cancelAnimationFrame(ot.get(t)),
                            function e() {
                                ...
                                if (t.setPosition(h + d * r, p + m * r), n >= i) "function" == typeof l && l.call(t);
                                else {
    ...
    var f = {
        init: function(t) {
            var e, n;
            t.window = (0, r.default)(window), t.document = (0, r.default)(document), t.html = (0, r.default)("html"), t.body = (0, r.default)("body"), t.viewport = (0, r.default)("html,body"), t.view = (0, r.default)("#view-main"), t.content = (0, r.default)(".wt-content"), t.loader = (0, r.default)(".wt-loader_overlay"), t.navbar = (0, r.default)(".wt-navbar:first"), t.navbarLogo = t.navbar.find(".wt-navbar-logo a"), t.navbarToggle = t.navbar.find(".wt-navbar-toggle button"), t.navbarNavItem = t.body.find("[data-section-target]"), t.navbarMenuContent = t.navbar.find(".wt-navbar-menu-content"), t.navbarMenuNavItem = t.navbar.find(".wt-navbar-menu-nav-item"), t.cursor = (0, r.default)('<div class="wt-cursor -loading"></div>'), t.tlMovement = [], t.browser = (0, s.default)(), t.mobile = t.browser.mobile || !!t.browser.os.match(/android/i), t.html.removeClass("no-js").addClass(t.mobile ? "mobile" : "desktop").addClass(t.browser.name), t.window.on("resize", function e() {
                ...
                t.navbar.removeClass("-open"), n && (e.preventDefault(), e.stopPropagation(), t.scrollTo("#section-" + n, {
                    duration: 1200
                }))
        ...
        update: function(t) {
            var e = t.req.html,
                ...
                i = (e.filter(".wt-navbar"), e.filter("title"));
            document.title = i.text(), t.view.replaceWith(n), t.view = n, t.viewport.scrollTop(0), t.content = n.find(".wt-content")
        },
        refresh: function(t) {
    ...
    r(r.S + r.F * !n(57)(function(t) {
        ...
        from: function(t) {
            ...
            if (g && (m = i(m, d > 2 ? arguments[2] : void 0, 2)), null == y || p == Array && a(y))
                for (n = new p(e = l(h.length)); e > v; v++) u(n, v, g ? m(h[v], v) : h[v]);
            else
    ...
    i._gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function() {
        ...
        return l.constructor = t, l.kill()._gc = !1, t.version = "2.1.3", l.invalidate = function() {
            ...
            this._gc && this._enabled(!0, !1);
            var r, s, a, l, u, c, f, h, p, d = this._time,
                ...
                b = this._paused,
                x = this._cycle;
            if (d !== this._time && (t += this._time - d), t >= m - 1e-8 && t >= 0) this._locked || (this._totalTime = m, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (s = !0, l = "onComplete", u = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && t >= -1e-8 || w < 0 || 1e-8 === w) && w !== t && this._first && (u = !0, w > 1e-8 && (l = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : 1e-8, this._yoyo && 1 & this._cycle ? this._time = t = 0 : (this._time = g, t = g + 1e-4);
            else if (t < 1e-8)
                if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, t > -1e-8 && (t = 0), (0 !== d || 0 === g && 1e-8 !== w && (w > 0 || t < 0 && w >= 0) && !this._locked) && (l = "onReverseComplete", s = this._reversed), t < 0) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (u = s = !0, l = "onReverseComplete") : w >= 0 && this._first && (u = !0), this._rawPrevTime = t;
                else {
            ...
            if (this._time !== d && this._first || i || u || f) {
                if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== v && t > 0 && (this._active = !0), 0 === v && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), (h = this._time) >= d)
                    for (r = this._first; r && (a = r._next, h === this._time && (!this._paused || b));)(r._active || r._startTime <= this._time && !r._paused && !r._gc) && (f === r && (this.pause(), this._pauseTime = p), r._reversed ? r.render((r._dirty ? r.totalDuration() : r._totalDuration) - (t - r._startTime) * r._timeScale, e, i) : r.render((t - r._startTime) * r._timeScale, e, i)), r = a;
                else
    ...
    i._gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function() {
        ...
        var u, c, f, h, p, d, m, g, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            ...
            Y = (i._gsScope.navigator || {}).userAgent || "",
            U = function() {
            ...
            it = function(t, e) {
                ...
                if (e = e || J(t))
                    if (n = e.length)
                        for (; --n > -1;) - 1 !== (r = e[n]).indexOf("-transform") && Nt !== r || (o[r.replace(C, A)] = e.getPropertyValue(r));
                    else
                        for (n in e) - 1 !== n.indexOf("Transform") && Dt !== n || (o[n] = e[n]);
        ...
        var vt = function(t, e, n, i) {
                ...
                return c ? r = e ? function(t) {
                    ...
                    if (e = (t.match(gt) || [o])[0], p = (h = t.split(e).join("").match(_) || []).length, c > p--)
                    ...
                    if (h = (e = t.match("," === u ? _ : w) || []).length, c > h--)
            ...
            wt = (X._parseToProxy = function(t, e, n, i, r, o) {
                ...
                for (n._transform = null, F = e, i = c = n.parse(t, e, i, r), F = m, o && (n._transform = d, f && (f._prev = null, f._prev && (f._prev._next = null))); i && i !== f;) {
                    if (i.type <= 1 && (p[a = i.p] = i.s + i.c, h[a] = i.s, o || (u = new _t(i, "s", a, u, i.r), i.c = 0), 1 === i.type))
                        for (s = i.l; --s > 0;) l = "xn" + s, p[a = i.p + "_" + l] = i.data[l], h[a] = i[l], o || (u = new _t(i, l, a, u, i.rxp[l]));
                    i = i._next
                }
                return {
                    proxy: h,
            ...
            xt = o.parseComplex = function(t, e, n, i, r, s, a, l, c, f) {
                ...
                var h, p, d, _, w, b, x, T, S, E, O, k, C, P = n.split(", ").join(",").split(" "),
                    ...
                    M = P.length,
                    R = !1 !== u;
                for (-1 === i.indexOf(",") && -1 === n.indexOf(",") || (-1 !== (i + n).indexOf("rgb") || -1 !== (i + n).indexOf("hsl") ? (P = P.join(" ").replace(N, ", ").split(" "), A = A.join(" ").replace(N, ", ").split(" ")) : (P = P.join(" ").split(",").join(", ").split(" "), A = A.join(" ").split(",").join(", ").split(" ")), M = P.length), M !== A.length && (M = (P = (s || "").split(" ")).length), a.plugin = c, a.setRatio = f, gt.lastIndex = 0, h = 0; h < M; h++)
                    if (_ = P[h], w = A[h] + "", (T = parseFloat(_)) || 0 === T) a.appendXtra("", T, ut(w, T), w.replace(y, ""), !(!R || -1 === w.indexOf("px")) && Math.round, !0);
        ...
        var kt, Ct, Pt, At, Mt, Rt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
            Dt = Q("transform"),
            Nt = G + "transform",
            ...
            Ft = i._gsScope.SVGElement,
            zt = function(t, e, n) {
                var i, r = q.createElementNS("http://www.w3.org/2000/svg", t),
                    o = /([a-z])([A-Z])/g;
            ...
            Ht = function(t, e, n, i, r, s) {
                var a, l, u, c, f, h, p, d, m, g, v, y, _, w, b = t._gsTransform,
                    x = Ut(t, !0);
            ...
            Yt = [1, 0, 0, 1, 0, 0],
            Ut = function(t, e) {
                var n, i, r, o, s, a, l, u = t._gsTransform || new It,
                    c = t.style;
            ...
            $t = X.getTransform = function(t, e, n, r) {
                ...
                var s, a, l, u, c, f, h = n && t._gsTransform || new It,
                    p = h.scaleX < 0,
            ...
            Gt = X.set3DTransformRatio = X.setTransformRatio = function(t) {
                var e, n, i, r, o, s, a, l, u, c, f, p, d, m, g, v, y, _, w, b, x = this.data,
                    T = this.t.style,
                    S = x.rotation,
                    E = x.rotationX,
                    O = x.rotationY,
        ...
        (l = It.prototype).x = l.y = l.z = l.skewX = l.skewY = l.rotation = l.rotationX = l.rotationY = l.zOrigin = l.xPercent = l.yPercent = l.xOffset = l.yOffset = 0, l.scaleX = l.scaleY = l.scaleZ = 1, Et("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(t, e, i, r, s, a, l) {
                ...
                u && (l.scale = u(g, t));
                var c, f, h, p, d, v, y, _, w, b = t._gsTransform,
                    x = t.style,
                    T = Rt.length,
                    S = l,
                    E = {},
            ...
            parser: function(t, i, r, o, s, a) {
                i = this.format(i);
                var l, u, c, f, h, p, d, m, g, v, y, _, w, b, x, T, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                    E = t.style;
        ...
        var Jt = function(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e) s.cssText = "", r = !0;
                    ...
                    for (i = (e = this.e.split(" ").join("").split(",")).length; --i > -1;) n = e[i], a[n] && (a[n].parse === l ? r = !0 : n = "transformOrigin" === n ? jt : a[n].p), Qt(s, n);
        ...
        (l = o.prototype)._firstPT = l._lastParsedTransform = l._transform = null, l._onInitTween = function(i, s, l, h) {
            ...
            for (s in i) {
                if (p = i[s], l = a[s], "function" != typeof p || l && l.allowFunc || (p = p(g, m)), l) r = l.parse(t, p, s, this, r, o, i);
                else {
                    if ("--" === s.substr(0, 2)) {
        ...
        return o.cascadeTo = function(t, e, n) {
            ...
            for (t = l._targets || l.target, ee(t, c, h), l.render(e, !0, !0), ee(t, f), l.render(0, !0, !0), l._enabled(!0), r = h.length; --r > -1;)
        ...
        ! function(t) {
            var e = t.GreenSockGlobals || t,
                ...
                _ = function(t, e, n, o, a, l, u) {
                    var c, f, h, p, g, _, w, b, x, T, S, E, O = r(t),
                        k = s(t, "paddingLeft", O),
                        C = -999,
                        P = s(t, "borderBottomWidth", O) + s(t, "borderTopWidth", O),
                        A = s(t, "borderLeftWidth", O) + s(t, "borderRightWidth", O),
                        M = s(t, "paddingTop", O) + s(t, "paddingBottom", O),
                        R = s(t, "paddingLeft", O) + s(t, "paddingRight", O),
                        D = .2 * s(t, "fontSize"),
                        N = s(t, "textAlign", O, !0),
                        j = [],
                        L = [],
                ...
                w = function t(e, n, r, o) {
                    ...
                    if (3 !== e.nodeType || p > 1) {
                        ...
                        for (O.insertBefore(E, t), E.textContent = t.nodeValue, O.removeChild(t), m = -1 !== (o = function t(e) {
                                ...
                                return i
                            }(t = E)).indexOf("<"), !1 !== e.reduceWhiteSpace && (o = o.replace(u, " ").replace(l, "")), m && (o = o.split("<").join("{{LT}}")), h = o.length, s = (" " === o.charAt(0) ? x : "") + n(), a = 0; a < h; a++)
    ...
    function s(t) {
        ...
        var i = window.console || {},
            o = Function.prototype.bind.call(i.error || i.log || function() {}, i);
    ...
    var a = {
        init: function(t, e) {
            ...
            t.navbarLogo.on("click", function(e) {
                e.preventDefault(), e.stopPropagation(), t.scrollTo("header", {
                    duration: 1200
                })
                ...
                t.on("mousemove", function(e) {
                    ...
                    var e = (0, i.default)(this).find(".wt-showreel-roll-item-img"),
                        n = e.find("video")[0];
                    o.default.to(e, .2, {
                        opacity: 1,
                        display: "block"
                    ...
                    var t = (0, i.default)(this).find(".wt-showreel-roll-item-img"),
                        e = t.find("video")[0];
                    o.default.to(t, .2, {
                        opacity: 0,
                        display: "none",
